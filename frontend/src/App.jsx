...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/assessment" element={<ProtectedRoute role="candidate"><CandidateTest /></ProtectedRoute>} />
      <Route path="/assessment/:sessionId" element={<ProtectedRoute role="candidate"><CandidateTest /></ProtectedRoute>} />
      <Route path="/resume-verification" element={<ProtectedRoute role="candidate"><ResumeVerification /></ProtectedRoute>} />
