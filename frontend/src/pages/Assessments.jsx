  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-medium text-slate-900">Live Assessments</h1>
          <p className="text-slate-500 text-sm">Monitor candidates currently taking the AI proctored test.</p>
        </div>
        <div className="text-xs font-medium text-emerald-600 bg-emerald-50 px-3 py-1.5 rounded-full border border-emerald-100 uppercase animate-pulse">
      ...
      {sessions.length > 0 ? (
            ...
            <div key={session.id} className="bg-white rounded-2xl border border-emerald-100 p-6 shadow-sm border-l-4 border-l-emerald-500 relative overflow-hidden group">
              <div className="flex justify-between items-start mb-6">
                <div className="flex items-center gap-4">
                   ...
                   <div>
                      <h3 className="font-medium text-slate-900">{session.candidate_name}</h3>
                      <p className="text-xs text-slate-500 font-medium">{session.role}</p>
                   </div>
                </div>
                <div className={`px-2.5 py-1 rounded text-[10px] font-medium uppercase ${
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                 <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
                    <span className="text-[10px] font-medium text-slate-400 uppercase block mb-1">Time Elapsed</span>
                 ...
                 <div className="bg-slate-50 p-3 rounded-xl border border-slate-100">
                    <span className="text-[10px] font-medium text-slate-400 uppercase block mb-1">Total Events</span>
                    <div className="flex items-center gap-1.5 text-sm font-medium text-slate-700">
              ...
              <div className="flex gap-3">
                <Link 
                  ...
                  className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-teal-700 text-white rounded-xl text-xs font-medium hover:bg-teal-800 transition-colors shadow-sm"
                >
        ...
        <div className="py-24 text-center bg-white rounded-3xl border border-slate-100 shadow-sm flex flex-col items-center animate-in fade-in zoom-in duration-700">
          ...
          <h3 className="text-2xl font-semibold text-slate-900 tracking-tight">No Active Assessments</h3>
